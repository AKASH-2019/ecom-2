...
class MyUserManager(BaseUserManager):            # user manager create
...
class User(AbstractBaseUser, PermissionsMixin):    # model create for user
...
@receiver(post_save, sender=User)     # any change of user model can be affected in a profile model
def save_profile(sender, instance, **kwargs):
    instance.profile.save()        # instance.(related name).save()